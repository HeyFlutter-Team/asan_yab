...
class _MessageHomeState extends ConsumerState<MessagePage> {
  ...
  Widget build(BuildContext context) {
    final messageNotifier = ref.watch(messageHistoryProvider);
    final messageDetails = ref.watch(messagesNotifierProvider);
