  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      try {
        ...
        final userMessages =
            messages.where((element) => element.userId == widget.uid).toList();
        ...
        onPopInvoked: (didPop) {
          FocusScope.of(context).unfocus();
            if (ref
                ...
                .textController
                .text
                .isNotEmpty||ref.watch(replayProvider.notifier).state.isNotEmpty) {
          ...
          ref
            ...
            if (FirebaseAuth.instance.currentUser != null) {
              ...
              ref
                  ...
                  .messageIsSeen(newProfileUser.uid!,
                              ...
                              Expanded(
                                child: Container(
                                  ...
                                  child: TextField(
                                    ...
                                    controller:
                                    ref.watch(messageProfileProvider.notifier).textController,
                                  ),
