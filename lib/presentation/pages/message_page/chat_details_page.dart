...
import 'package:asan_yab/presentation/widgets/message/app_bar_chat_details_widget.dart';
import 'package:asan_yab/presentation/widgets/message/chat_messages_widget.dart';
...
class _ChatDetailPageState extends ConsumerState<ChatDetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBarChatDetailsWidget(
                    ...
                    Row(
                      children: <Widget>[
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () => sendMessage(context, newProfileUser),
                          child: Icon(
                            Icons.send,
