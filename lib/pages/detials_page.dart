           ...
           child: Column(
             ...
             Padding(
               ...
               child: Container(
                 ...
                 child: Image.network("${widget.places.coverImage}",
                     fit: BoxFit.cover),
               ),
             ),
               ...
               child: RichText(
                 text: TextSpan(
                     ...
                     children: [
                       ...
                       TextSpan(
                         text:
                         '\n ${widget.places.phoneNumbers.join('\n شماره تماس')}',
                         style: TextStyle(
                           color: Colors.blueGrey.withOpacity(0.7),
                         ),
                       ),
                       TextSpan(text:'\n${widget.places.adresses[0].address}', style: TextStyle(
               ...
               child: PageView.builder(
                 ...
                 itemBuilder: (context, index) {
                   return Padding(
                     ...
                     child: PageViewItem(
                         selectedIndex: index, gallery: widget.places.gallery),
                   );
                 },
               ),
             ),
